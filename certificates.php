...
<body>
  <div class="desktopnav">
    ...
    <img src="images/fluent_certificate-16-regular.png" alt="" srcset="" class="nav-icons" id="dashboard-icon">
    <a href="certificates.php" style="text-decoration: none;">
      <p style="margin-left:40px">Certificates</p>
    </a>
    </div>
  ...
  <div class="main-content">
    ...
    <div class="first-row">
      <a href="images/sample-certificate.jpg" download>
      <div class="certificates">  
      <img src="images/sample-certificate.jpg" alt="" srcset="" class="certificates"></div>
    </a>
    <a href="images/sample-certificate.jpg" download>
    <div class="certificates"> <img src="images/sample-certificate.jpg" alt="" srcset=""class="certificates"></div>
    </a>
    <a href="images/sample-certificate.jpg" download>
    <div class="certificates"> <img src="images/sample-certificate.jpg" alt="" srcset=""class="certificates"></div>

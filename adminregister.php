...
$duplicate = mysqli_query($conn, "SELECT * FROM adminlogin WHERE username = '$username' OR email = '$email'");
...
$query = "INSERT INTO adminlogin VALUES('', '$fullname', '$username', '$email', '$password')";
...
<a href="adminlogin.php">Already an admin? Login</a>
</form>
</div>
<br>
<div class="right">

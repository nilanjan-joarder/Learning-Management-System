...
<body>
    ...
    <div style="border-bottom:2px solid white; width:fit-content; margin-left:20px; padding-bottom:10px;" ;>  <img src="images/icon-video.png" alt="" srcset="" class="nav-icons"  id="dashboard-icon">
        <a href="upload-video.php" style="text-decoration: none;">
            <p class="nav-bar-notes" style="margin-left:40px">Upload Video</p>
        </a>
    </div>
    </div>
        ...
        <div class="container">
            ...
            <form action="#" method="POST">
                <div class="form-group">
                    ...
                    <label for="course_picture">Video (MP4, AVI, MKV, MOV, WMV, FLV, WEBM):</label>
                    <input type="file" id="course_picture" name="course_picture" accept="Video/*" >
                </div>
                <div class="form-group">
                    <label for="course_name">Video Name:</label>
                    <input type="text" id="course_name" name="course_name" required style="width: 100%; border-radius: 5px;">
                </div>
        
                <div class="form-group">
                    <label for="course_description">Video Description:</label>
